    ...
    <div class="col-md-12 mr-b-30">
        <div class="card blog-post-new">
            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                <figure>
                    <a href="javascript:void(0);">
                        <img class="card-img-top" src="{{asset('uploads/narkoba/narkotika/'.$narkotika->gambar)}}" height="400" alt="">
                    </a>
                </figure><span class="badge badge-danger text-uppercase">Golongan : {{$narkotika->golongan}}</span>

            </div>
            <div class="card-body sub-heading-font-family">
                <h5 class="card-title sub-heading-font-family mb-3">{{$narkotika->nama}}</h5>
                  ...
                  <div class="icon-box icon-box-side icon-box-circle-bg">
                    <header class="align-self-start"><a href="#" class="bg-danger"><i class="lnr lnr-sad"></i></a>
                      ...
                      <section>
                          ...
                          <p class="text-danger">{!!$narkotika->dampak!!}</p>
            ...
            <div class="card-action">
              <button type="button" onclick="window.location='{{route("narkotika.index")}}'" class="btn btn-info" name="button">Kembali</button>
